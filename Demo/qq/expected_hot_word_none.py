...
class MyThread(threading.Thread):
    def __init__(self, thread_index, result__sheet, source_sheet):
    ...
    def run(self):
        try:
            ...
            for i in range(1, 261):
                search_word = source_sheet.cell(i, 1).value
...
def startThread(source_file, result_file):
    ...
    thread = MyThread(0, result__sheet, source_sheet)
    thread.start()
    thread.join()
...
startThread('E:/hot_word_none.xls', 'E:/hot_word_none_result.xls')
end_time = time.time()
